...
{
	return _Sec = (DOUBLE)_Total.QuadPart / _Freq.QuadPart;
}

double HiRessTimeMeasure::GetEllapsedMiliseconds(void)
{
	return _Milisec = (DOUBLE)(_Total.QuadPart * 1000) / _Freq.QuadPart;
}

inline DWORD64 HiRessTimeMeasure::GetEllapsedCPUCycles(void)
{
	return  rdtsTotal = (rdtscEnd - rdtscBegin);
}

double HiRessTimeMeasure::GetEllapsedMicroseconds(void)
{
	return  	_Microsec = (DOUBLE)(_Total.QuadPart * 1000000) / _Freq.QuadPart;
}
