========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта OpenComunicationModule_LibUSB
========================================================================

Это приложение OpenComunicationModule_LibUSB создано автоматически с помощью мастера 
приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения OpenComunicationModule_LibUSB.


OpenComunicationModule_LibUSB.vcxproj
...
OpenComunicationModule_LibUSB.vcxproj.filters
...
OpenComunicationModule_LibUSB.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем OpenComunicationModule_LibUSB.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
