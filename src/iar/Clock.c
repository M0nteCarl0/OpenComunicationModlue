...
{  
 ...
 //RCC_PLLConfig(RCC_PLLSource_HSE,8,400,2,4);//200 mhz CORE
...
void Clock_InitClocs(Clocks CLK)
{
    ...
    else
    {
      ...
      DeviceClocks.AHB = (DeviceClocks.OSC_Hertz * (CLK.PLLN/CLK.PLLM)) / CLK.PLLP;
...
uint32_t Clock_GetAHBDicider(uint32_t DivAllias)
{
      ...
      switch(DivAllias)
      {
      case RCC_SYSCLK_Div1:{      Divider = 1;    break;};
      case RCC_SYSCLK_Div2:{      Divider = 2;     break;};
      case RCC_SYSCLK_Div4:{      Divider = 4;    break;};
      case RCC_SYSCLK_Div8:{      Divider = 8;    break;};
      case RCC_SYSCLK_Div16:{     Divider = 16;    break;};
      case RCC_SYSCLK_Div64:{     Divider = 64;    break;};
      case RCC_SYSCLK_Div128:{    Divider = 128;    break;};
      case RCC_SYSCLK_Div256:{    Divider = 256;    break;};
      case RCC_SYSCLK_Div512:{    Divider = 512;    break;};
...
uint32_t Clock_GetAPBDicider(uint32_t DivAllias)
{
    ...
    switch(DivAllias)
    {
    case RCC_HCLK_Div1:{  Divider = 1;    break;};
    case RCC_HCLK_Div2:{  Divider = 2;     break;};
    case RCC_HCLK_Div4:{  Divider = 4;    break;};
    case RCC_HCLK_Div8:{  Divider = 8;    break;};
    case RCC_HCLK_Div16:{ Divider = 16;    break;};}
    return  Divider;
}
/******************************************************************************/
